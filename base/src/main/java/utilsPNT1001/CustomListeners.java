...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        System.out.println("..... START execution Of tests located in CLASS :" + iTestContext.getName() + " .....");

    }

    @Override
    public void onFinish(ITestContext iTestContext) {
        System.out.println("..... END execution Of tests located in CLASS :" + iTestContext.getName() + " .....");
